...
Generated from commit `3abe10d`. Benchmarks ran on: Apple M1, 8 cores, Darwin 25.6.0.
...
**Takeaway:** At n = 1,000,000 every policy simulates in at most 1.67 s (slowest: prio-p) with at most 307 MB peak memory; fitted log-log slopes from n = 10^4 lie between 1.01 and 1.06 (1.0 = linear).
...
**Takeaway:** With the ready queue growing to about n/2, the largest fitted slope is 1.33 (lottery): no policy is quadratic.
